...
class ProtectedGalleryModel(UpdateInfoBaseModel):
    """   
    ...
    path = models.CharField(max_length=1024, 
        help_text=_("Base path (relative to MEDIA_ROOT '%s' or absolute)") % settings.MEDIA_ROOT
    )

    template = models.CharField(max_length=256,
        default="ProtectedGallery/default.html",
    ...
    def __unicode__(self):
        return "ProtectedGalleryModel for %s" % self.pagetree.get_absolute_url()
