...
class ProtectedGalleryPluginTest1(basetest.BaseUnittest):
    """
    ...
    def _pre_setup(self, *args, **kwargs):
        ...
        super(ProtectedGalleryPluginTest1, self)._pre_setup(*args, **kwargs)
    ...
    def _create_gallery(self):
        ...
        self.assertResponse(response,
            must_contain=(
                ...
                'The gallery model &quot;ProtectedGalleryModel for /gallery_test/&quot; was added successfully.',
                'Directory',
